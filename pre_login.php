		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-7 col-lg-5">
		      	...
		      	<h1 class="text-center mb-4" style="color: white;">Welcome to  Music Portal<br></h1>
                <br><p style="color: white;"> login first----->Restricted</p>
						<form action="#" class="signup-form"><br><br><br>
		      		

	              <div class="form-group" >
	            	<button type="submit" class="form-control btn btn-primary submit px-3"><a href="user.php">Click Here to login</a></button>
	            </div><br><br><br>
