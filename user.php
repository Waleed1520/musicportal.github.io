		...
		<div class="container">
			...
			<div class="row justify-content-center" >
	            ...
	            <div class="form-group">
	            	<button type="submit" class="form-control btn btn-success submit px-3" name="submit" style="background-color: black;">Log In</button>
	            </div>
	          ...
	          <b><p style="color: white;"> If You Don't Have Account<br>Create Account! <a  href="user_registration.php">Sign Up</a></p></b>
	        </div>
				</div>
			</div>
		</div>
